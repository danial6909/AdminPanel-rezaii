...
//پس رول‌بندی جایگزین ارسال توکن نمی‌شود؛ بلکه بخشی از اطلاعاتی است که توکن به صورت امن حمل می‌کند. شما توکن را می‌فرستید تا سرور هم هویت شما را تأیید کند (بفهمد شما کی هستید) و هم بفهمد چه نقشی دارید (چه کارهایی می‌توانید انجام دهید).
